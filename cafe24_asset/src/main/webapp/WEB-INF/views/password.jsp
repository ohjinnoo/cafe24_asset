...
<!DOCTYPE html>
	...
	<script src="${pageContext.request.contextPath}/js/jquery-ui-1.11.4.js"></script>
  	<script src="${pageContext.request.contextPath}/js/functionutils.js" type="text/javascript"></script>
  	<script src="${pageContext.request.contextPath}/js/common.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/jquery.form.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/jquery.session.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/jquery.serializeObject.js" type="text/javascript"></script>
